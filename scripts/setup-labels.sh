...
gh label create "agent:product-manager"    --color 5319e7 --description "Product Manager's turn to act" --force
...
gh label create "agent:ui-designer"         --color 1d76db --description "UI Designer's turn to act" --force
gh label create "agent:scene-developer"     --color 1d76db --description "Scene Developer's turn to act" --force
...
gh label create "status:blocked"          --color d93f0b --description "Escalation — pairs with whichever agent:* label is receiving it" --force
...
gh label create "status:ready-for-client-test" --color fbca04 --description "Integrated UI awaiting client hands-on verdict via Product Manager" --force
gh label create "status:ready-for-review" --color fbca04 --description "UI design awaiting client review via Product Manager" --force
...
echo "Done — run 'gh label list' to confirm all 27 are there."
