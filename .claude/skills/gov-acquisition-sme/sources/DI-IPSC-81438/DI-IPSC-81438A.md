# DI-IPSC-81438A — extracted text

| Field | Value |
| --- | --- |
| Source file | `DI-IPSC-81438A_Revision_A_04F49B627B844DFDAF719C2873A086D5.pdf` |
| Pages | 7 |
...
This DID supersedes DI-IPSC-8 1438.
Requirements:
...
Source: https://assist.dla.mil -- Downloaded: 2026-09-15T21:03Z
...
substituted for ail or part of the document if they contain the required data.
...
measured for each CSCI.” Included shall be a statement of the extent of testing to be performed
...
4.2.x.y (Project-unique identifier of a test). This paragraph shall identify a test by
