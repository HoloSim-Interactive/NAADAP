# DI-IPSC-81433A — extracted text

| Field | Value |
| --- | --- |
| Source file | `DI-IPSC-81433_Revision_A_CA7244D03F974B03930B480EE53AA2D4.pdf` |
| Pages | 11 |
...
This DID supersedes DI-IPSC-8 1433.
Requirements:
...
Source: https://assist.dla.mil -- Downloaded: 2026-09-15T20:52Z
...
3.4 CSCI internal interface requirements. This paragraph shall specify the requirements,
if any, imposed on interfaces internal to the CSCI. If all internal interfaces are left to the design,
...
3.5 CSCI internal data requirements. This paragraph shall specify the requirements, if
...
requirements, if any, concerned with maintaining security and privacy. These requirements shall
...
if any, regarding computer software that must be used by, or incorporated into, the CSCI
...
requirements, if any, that constrain the design and implementation of the CSCI. These
...
Also included shall be the human factors engineering requirements, if any, imposed on the CSCI.
...
b. Test: The operation of the CSCI, or a part of the CSCI, using instrumentation or other
...
d. Inspection: The visual examination of CSCI code, documentation, ete.
