...
| Draft A.4 | 2026-09-17 | Minor update per §1.6 item 5: PCA-1 entered; submission tag `v1.0.156` and merge to `main` recorded (§1.1, Table 3.1-1); Increment 1 work merged to `main` by fast-forward on the Principal's authorization. | Systems Engineer |
...
| PCA-1: clean-clone build of the tagged package | 1 | entered 2026-09-17 | <a href="#semp-3-2-13" target="_blank">§3.2.13</a>; <a href="https://github.com/HoloSim-Interactive/NAADAP/blob/main/docs/setr/reviews/PCA-1-2026-09-17.md" target="_blank"><code>docs/setr/reviews/PCA-1-2026-09-17.md</code></a> | In progress: audit of the merged commit complete (build, tests, smoke, reference run, inventory); tag `v1.0.156` push, image build and digests, and the GitHub Release assigned to the Principal (RFA-PCA1-1) because the agent environment cannot push tags |
