...
| CORE-200 | Non-LLM clustering/requirement-extraction algorithm groups documents (or requirement statements within them) by shared acquisition-requirement content. | SN-1, SN-6 | Test | Verified | 0b69958 |
