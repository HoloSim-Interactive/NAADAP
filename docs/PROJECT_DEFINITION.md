...
<!-- What's being deliberately deferred or excluded — this list
     matters as much as what's in scope. Ask the client to veto
     anything here they actually expected included. -->

## Deliverable Requirements

<!-- Non-functional requirements about what gets handed over, not
     what the running program does — e.g. "must be a modifiable,
     IDE-ready codebase," dependency policy, documentation
     expectations. See "Deliverable-format requirements" in
     solutions-architect.md. These become docs/SDD.md build/toolchain
     conventions, not RTVM line items. -->
